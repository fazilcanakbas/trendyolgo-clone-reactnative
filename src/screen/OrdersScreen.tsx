...
export default function index() {
  ...
  return (
       ...
       <View style={{alignItems:'center',paddingTop:19,padding:10}}>
        ...
        {orders.map((order) => (
          <View key={order.id} style={{width:width*0.9,height:height*0.27,backgroundColor:'white',borderRadius:10,marginLeft:'auto',marginRight:'auto',marginTop:20,elevation:2,flexDirection:'column',gap:0}}>
